...
public class RecipeActivity26 extends BulkingMenuOfferActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] ingr = new String[]{"56 g csirkemell filé", "85 g citrom", "100 g rizs", "só ízlés szerint", "bors ízlés szerint", "chili ízlés szerint", "kakukkfű ízlés szerint", "3 gerezd fokhagyma"," 200 g cukkinivirág"," 25 g vaj", "250 g víz"};
