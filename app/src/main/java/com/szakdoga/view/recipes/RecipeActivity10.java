...
public class RecipeActivity10 extends BulkingMenuOfferActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] ingr = new String[]{"345 g piros kaliforniai paprika", "75 g cheddar sajt", "75 g mozzarella",
                "10 g kolbász","125 g koktélparadicsom", "8 g olívaolaj", "15 g pizzaszósz", "só ízlés szerint",
                "bors ízlés szerint", "oregánó ízlés szerint", "bazsalikom ízlés szerint"};
