...
public class RecipeActivity17 extends BulkingMenuOfferActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] ingr = new String[]{"150 g darált sertéshús", "0.3 nagy fej vöröshagyma"," 1 gerezd fokhagyma", "30 g kápia paprika"," 25 g zöldpaprika", "50 g sűrített paradicsom"," 0.5 db chili", "100 g vörösbab", "100 g csemegekukorica", "13 g mexikói alap", "só ízlés szerint", "bors ízlés szerint", "cayenne bors ízlés szerint", "10 g kókuszolaj"};
